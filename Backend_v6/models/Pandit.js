...
resetPasswordToken: {
  ...
  resetPasswordExpires: {
   ...
   statusHistory: [{
    ...
    reason: {
      type: String,
      enum: ['manual_toggle', 'auto_inactivity', 'session_expired', 'admin_override', 'login', 'logout']
    },
    timestamp: {
      type: Date,
      default: Date.now
...
panditSchema.methods.recordStatusChange = async function(status, reason) {
  this.statusHistory.push({ status, reason, timestamp: new Date() });
