...
const effectiveMongoUri = mongoUri || 'mongodb://localhost:27017/pujanam';
...
db.once('open', () => {
  ...
  // Start scheduled cleanup jobs after DB is ready
  startCleanupJobs();
});
...
// SECURITY FIX: All debug routes disabled in production to prevent data leaks
...
app.get('/api/debug', debugGuard, (req, res) => {
  res.json({
...
app.get('/api/debug/pandits', debugGuard, async (req, res) => {
...
app.get('/api/debug/users', debugGuard, async (req, res) => {
...
app.get('/api/debug/token', debugGuard, async (req, res) => {
...
app.get('/api/debug/bookings', debugGuard, async (req, res) => {
...
app.get('/api/debug/notifications', debugGuard, async (req, res) => {
...
app.get('/api/test', debugGuard, (req, res) => {
  console.log('✅ Test endpoint hit!');
  res.json({ message: 'Test endpoint working' });
});

app.get('/api/test-bookings', debugGuard, async (req, res) => {
...
// ================= 404 =================
// NOTE: 404 must come BEFORE the error handler
app.use('*', (req, res) => {
  res.status(404).json({
    success: false,
...
// ================= ERROR HANDLER =================
// NOTE: Must be last middleware (after 404 handler)
