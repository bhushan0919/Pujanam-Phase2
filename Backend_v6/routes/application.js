  ...
  try {
    ...
    const html = status === 'approved'
      ? `
        ...
        <body>
          <h2>Dear ${name},</h2>
          <p>Congratulations! Your application to become a Pandit at <strong>Pujanam</strong> has been <strong style="color:green">APPROVED</strong>.</p>
          ...
          <p>Thank you for joining Pujanam!</p>
          <br/>
      ...
      : `
        ...
        <body>
          <h2>Dear ${name},</h2>
          <p>Thank you for your interest in becoming a Pandit at <strong>Pujanam</strong>.</p>
