...
// ✅ Cancel booking when payment is dismissed/failed (before payment completed)
router.post('/payment-cancelled', authenticateCustomer, paymentController.handlePaymentCancelled);
