...
async function sendTestEmail() {
  ...
  const testEmail = {
    from: `"Pujanam Test" <${emailUser}>`,
    to: emailUser, // Send to the configured email
    subject: '✅ Pujanam Email Service is Working!',
    html: `
      <!DOCTYPE html>
      <html>
      <head>
      ...
      <body>
        <div class="container">
          ...
          <div class="footer">
            <p>© ${new Date().getFullYear()} Pujanam. All rights reserved.</p>
    ...
    `,
    text: 'Pujanam Email Service is Working!',
  };
