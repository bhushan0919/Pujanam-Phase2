    ...
    <div className="mx-auto w-full max-w-[1440px] px-4 sm:px-5 lg:px-6">
      ...
      <nav className="relative flex items-center justify-between gap-3 py-2.5 lg:min-h-[68px]">
        ...
        <Link to="/" className="flex items-center gap-2.5 text-left no-underline" onClick={closeMenus}>
          <img src="/icon.png" alt="Pujanam Logo" className="h-12 w-12 object-contain sm:h-13 sm:w-13 lg:h-14 lg:w-14" />
          <span className="flex flex-col leading-none">
            <span className="font-serif text-[24px] font-extrabold tracking-[-0.5px] text-[#8a2b2b] sm:text-[26px] lg:text-[28px]">{t('pujanam')}</span>
            <span className="mt-0.5 max-w-[260px] text-[10px] font-medium leading-3 text-stone-500 sm:max-w-[300px] sm:text-[11px]">
  {t('tagline')}
</span>
          </span>
        </Link>
