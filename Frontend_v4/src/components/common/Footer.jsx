...
const SUPPORT_LINKS = [
  ...
  { label: 'Live Chat',     to: 'liveChat',    Icon: MessageCircle    },
  { label: 'Call Support',  to: '/contact', Icon: PhoneCall        },
  { label: 'Email Support', to: '/contact', Icon: Mail             },
  { label: 'Track Booking', to: '/trackBooking',   Icon: Search           },
];

const SOCIAL = [
  { fa: faFacebookF, href: '#', label: 'Facebook'},
  { fa: faXTwitter,  href: '#', label: 'Twitter' },
  { fa: faInstagram, href: 'https://instagram.com/bhushan_0919', label: 'Instagram'},
  { fa: faYoutube,   href: 'https://youtube.com/@pujanamIndia', label: 'YouTube'},
    ...
    <footer className="mt-auto w-full overflow-visible bg-[linear-gradient(180deg,#FDF6EC_0%,#F5E8D0_55%,#EDD9B5_100%)] text-[#2E1A06]">
      ...
      <div className="mx-auto grid max-w-[1450px] gap-4 px-5 py-10 lg:grid-cols-5 lg:gap-0 lg:px-8 lg:py-[15px]">
        <div className="space-y-4 lg:col-span-1 lg:border-r lg:border-amber-200/50 lg:pr-8">
          <div className="flex items-center gap-4">
            ...
            <div>
              <p className="m-0 font-serif text-xl font-bold leading-tight tracking-[0.3px] text-[#2E1A06]">Pujanam</p>
              <p className="mt-1 font-serif text-[8.5px] font-medium uppercase tracking-[1.8px] text-amber-600">Comprehensive Portal for Pandit Booking, Puja Services & Samagri Management</p>
            </div>
          </div>
          ...
          <p className="max-w-sm text-[13.5px] leading-7 text-[#5C3410]">
            ...
            {/* Comprehensive Portal for Pandit Booking, Puja Services & Samagri Management */}
          </p>
          ...
          <ul className="list-none m-0 p-0 space-y-4">
            ...
            <li className="flex items-start gap-3">
              ...
              <div>
                ...
                <a className="text-[15px] text-[#2E1A06] transition hover:text-[#7A1024]" href="mailto:gavhaneb02@gmail.com">gavhaneb02@gmail.com</a>
              </div>
            </li>
            <li className="flex items-start gap-3">
      ...
      <div className="border-t border-amber-200/60 bg-[#f5e8d0]/40 px-5 py-5">
        <div className="mx-auto flex max-w-[1400px] flex-col items-center justify-between gap-4 text-center lg:flex-row">
          ...
          <p className="text-sm text-[#5C3410]">© {new Date().getFullYear()} Pujanam. All rights reserved. Developed by Bhushan Gavhane.</p>
