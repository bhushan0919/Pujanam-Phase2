...
const TESTIMONIALS = [
  {
    text: 'Pujanam made our Griha Pravesh ceremony so peaceful and perfect. Highly recommended!',
    author: 'Rahul Sharma',
    city: 'Mumbai',
  },
  {
  ...
  {
    text: 'Authentic service, knowledgeable Pandit and great support team. Thank you Pujanam!',
    author: 'Amit Verma',
    city: 'Delhi',
  },
];
  ...
  return (
    <section className="mx-auto w-[calc(100%-2rem)] max-w-[1360px] py-6 sm:w-[calc(100%-2.5rem)] sm:py-8 lg:py-10">
      <div className="rounded-[30px] border border-[#edd9b4] bg-[radial-gradient(circle_at_top_left,rgba(255,248,239,0.95),rgba(250,239,221,0.98))] px-4 py-4 shadow-[0_18px_50px_rgba(95,59,20,0.08)] sm:px-5 sm:py-5 lg:px-6 lg:py-6">
          ...
          <section className="overflow-hidden rounded-[26px] border border-[rgba(214,179,116,0.25)] bg-white/80 p-4 shadow-[0_10px_28px_rgba(98,60,20,0.08)] backdrop-blur-sm sm:p-5">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 xl:grid-cols-4">
              {featuredServices.map((service) => (
                ...
                >
                  <div className="relative h-28 sm:h-[115px] overflow-hidden bg-[#f4e4cf]">
                    <img
                      src={service.image}
                      alt={service.title}
            ...
            <div className="space-y-3">
              {topRatedPandits.map((pandit) => (
                <button
                  ...
                  type="button"
                  onClick={() => navigate('/find-pandit')}
                  className="flex w-full flex-col sm:flex-row items-start sm:items-center justify-between gap-3 rounded-[20px] border border-[#efdfc3] bg-white px-3 py-3 text-left shadow-[0_5px_14px_rgba(94,58,20,0.05)] transition hover:-translate-y-0.5 hover:shadow-[0_10px_22px_rgba(94,58,20,0.1)]"
                >
                  <div className="flex min-w-0 items-center gap-3.5 w-full">
                  ...
                  <div className="flex shrink-0 items-center gap-3 mt-3 sm:mt-0">
                    ...
                    <span className="inline-flex w-full sm:w-auto justify-center rounded-full border border-[rgba(140,70,20,0.2)] bg-[#fff7ef] px-3 py-2 text-xs font-semibold text-[#8a4e12] transition group-hover:bg-[#fff1da]">
                      Book Now
                    </span>
                  </div>
                </button>
        ...
        <section className="mt-5 rounded-[26px] border border-[rgba(214,179,116,0.25)] bg-white/75 px-3 py-4 shadow-[0_10px_24px_rgba(98,60,20,0.06)] sm:px-5 sm:py-5">
