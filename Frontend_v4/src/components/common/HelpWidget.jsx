...
const HelpWidget = () => {
  ...
  const helpOptions = [
    ...
    },
    {
      ...
      action: () => window.open('https://wa.me/919876543210?text=Hi%20Pujanam%2C%20I%20need%20help.', '_blank', 'noopener,noreferrer'),
      color: '#25D366',
    },
    {
      icon: faEnvelope,
      label: 'Email Support',
      description: 'support@pujanam.com',
      action: () => globalThis.location.assign('mailto:support@pujanam.com'),
      color: '#FF6B6B',
    },
    {
